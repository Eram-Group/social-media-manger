...
const NAV = [
  ...
  { to: EPCC_ROUTES.ANALYTICS, label: 'Analytics & Reports', icon: FileBarChart },
  { to: EPCC_ROUTES.COMPETITORS, label: 'Competitors', icon: Swords },
  { to: EPCC_ROUTES.DISCOVER, label: 'Discovery', icon: Hash },
